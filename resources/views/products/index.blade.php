                    ...
                    <div class="bg-white rounded-2xl shadow-lg p-6 border border-gray-100 sticky top-4">
                        ...
                        <form method="GET" action="{{ route('products.index') }}" class="space-y-6">
                            ...
                            <div class="space-y-3 pt-2">
                                ...
                                <a href="{{ route('products.index') }}" class="block w-full bg-white text-gray-700 px-6 py-3 rounded-xl font-semibold hover:bg-gray-50 transition-all duration-200 border-2 border-gray-300 text-center">
                                    Clear Filters
                                </a>
                            </div>
                        </form>
                ...
                <div class="flex-1">
                    ...
                    @else
                        <div class="bg-white rounded-2xl shadow-lg p-16 text-center border border-gray-100">
                            ...
                            <a href="{{ route('products.index') }}" class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-primary-600 to-primary-700 text-white rounded-xl font-semibold hover:from-primary-700 hover:to-primary-800 transition-all duration-200 shadow-lg hover:shadow-xl">
                                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
