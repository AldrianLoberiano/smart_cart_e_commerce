            ...
            <div class="lg:col-span-1">
                <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden sticky top-6">
                    ...
                    <nav class="p-4 space-y-2">
                        <a href="{{ route('account.index') }}" class="group flex items-center px-4 py-3 text-sm font-medium rounded-xl transition-all duration-200 {{ request()->routeIs('account.index') ? 'bg-gradient-to-r from-primary-500 to-primary-600 text-white shadow-lg shadow-primary-500/50' : 'text-gray-700 hover:bg-gray-100' }}">
                            <div class="flex items-center justify-center w-8 h-8 rounded-lg {{ request()->routeIs('account.index') ? 'bg-white/20' : 'bg-gray-100 group-hover:bg-white' }} transition-all mr-3">
                        ...
                        <a href="{{ route('orders.index') }}" class="group flex items-center px-4 py-3 text-sm font-medium text-gray-700 hover:bg-gray-100 rounded-xl transition-all duration-200">
                        ...
                        <a href="{{ route('account.edit') }}" class="group flex items-center px-4 py-3 text-sm font-medium text-gray-700 hover:bg-gray-100 rounded-xl transition-all duration-200">
                            <div class="flex items-center justify-center w-8 h-8 rounded-lg bg-gray-100 group-hover:bg-white transition-all mr-3">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="{{ route('account.password') }}" class="group flex items-center px-4 py-3 text-sm font-medium text-gray-700 hover:bg-gray-100 rounded-xl transition-all duration-200">
                            <div class="flex items-center justify-center w-8 h-8 rounded-lg bg-gray-100 group-hover:bg-white transition-all mr-3">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    ...
                    <div class="group bg-gradient-to-br from-amber-500 to-orange-600 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden relative">
                        ...
                        <div class="relative p-6 text-white">
                            ...
                            <p class="text-4xl font-bold">{{ auth()->user()->orders()->where('status', 'pending')->count() }}</p>
                    ...
                    <div class="group bg-gradient-to-br from-emerald-500 to-teal-600 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden relative">
                        ...
                        <div class="relative p-6 text-white">
                            ...
                            <p class="text-teal-100 text-xs mt-2">{{ auth()->user()->created_at->diffForHumans() }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                    <div class="bg-gradient-to-r from-gray-50 to-gray-100 px-6 py-5 border-b border-gray-200">
                        <div class="flex items-center justify-between">
                            ...
                            <a href="{{ route('orders.index') }}" class="inline-flex items-center px-4 py-2 bg-primary-600 hover:bg-primary-700 text-white text-sm font-medium rounded-xl transition-all duration-200 shadow-md hover:shadow-lg">
                                View All
                    ...
                    <div class="p-6">
                            ...
                            <div class="group border-2 border-gray-100 hover:border-primary-200 rounded-xl p-5 transition-all duration-300 hover:shadow-lg bg-gradient-to-r from-white to-gray-50">
                                <div class="flex items-start justify-between mb-3">
                                    <div class="flex items-center space-x-4">
                                        ...
                                        <div>
                                            <p class="font-bold text-gray-900 text-lg">Order #{{ $order->order_number }}</p>
                                ...
                                <div class="flex items-center justify-between pt-3 border-t border-gray-100">
                                    ...
                                    <div class="flex items-center space-x-4">
                                        ...
                                        <a href="{{ route('orders.show', $order) }}" class="inline-flex items-center px-4 py-2 bg-primary-600 hover:bg-primary-700 text-white text-sm font-medium rounded-lg transition-all duration-200 shadow-sm hover:shadow-md">
                                            View Details
                        ...
                        <div class="text-center py-16">
                            ...
                            <a href="{{ route('products.index') }}" class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-primary-600 to-primary-700 hover:from-primary-700 hover:to-primary-800 text-white font-medium rounded-xl transition-all duration-200 shadow-lg hover:shadow-xl">
