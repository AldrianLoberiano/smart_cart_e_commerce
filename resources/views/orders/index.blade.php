        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                <nav class="flex items-center text-sm text-gray-600 mb-4">
                    ...
                    <a href="{{ route('account.index') }}" class="hover:text-primary-600 transition">Account</a>
                    <svg class="w-4 h-4 mx-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                    </svg>
            ...
            @if ($orders->isEmpty())
                <div class="bg-white rounded-2xl shadow-lg p-16 text-center border border-gray-100">
                    <div
                        class="inline-flex items-center justify-center w-24 h-24 rounded-full bg-gradient-to-br from-primary-50 to-primary-100 mb-6">
                    ...
                    <p class="text-gray-600 mb-8 max-w-md mx-auto">Start your shopping journey and discover amazing products
                        in our store</p>
                    <a href="{{ route('home') }}"
                            ...
                            <div class="bg-gradient-to-r from-gray-50 to-white px-6 py-5 border-b border-gray-200">
                                <div class="flex flex-wrap items-center justify-between gap-4">
                                    <div class="flex flex-wrap items-center gap-x-8 gap-y-3">
                                        <div>
                                            <p class="text-xs font-medium text-gray-500 uppercase tracking-wide mb-1">Order
                                                Number</p>
                                            <p class="font-bold text-gray-900 text-lg">#{{ $order->order_number }}</p>
                                        </div>
                                        <div>
                                            <p class="text-xs font-medium text-gray-500 uppercase tracking-wide mb-1">Date
                                                Placed</p>
                                        ...
                                        <div>
                                            <p class="text-xs font-medium text-gray-500 uppercase tracking-wide mb-1">Total
                                                Amount</p>
                                            <p class="font-bold text-primary-600 text-lg">
                                                ${{ number_format($order->total, 2) }}</p>
                                        </div>
                                        <div>
                                            <p class="text-xs font-medium text-gray-500 uppercase tracking-wide mb-1">Status
                                            </p>
                                            <span
                                        ...
                                        @elseif($order->status === 'cancelled') bg-gradient-to-r from-red-100 to-red-200 text-red-800 border border-red-300 @endif">
                                                <span
                                                ...
                                                @elseif($order->status === 'cancelled') bg-red-600 @endif">
                                                </span>
                                            ...
                                            <div class="flex-shrink-0">
                                                @if ($item->product && $item->product->image)
                                                    <img src="{{ asset('storage/' . $item->product->image) }}"
                                                        ...
                                                        class="h-20 w-20 rounded-xl object-cover shadow-md border-2 border-white">
                                                @else
                                                    <div
                                                        class="h-20 w-20 bg-gradient-to-br from-gray-200 to-gray-300 rounded-xl flex items-center justify-center shadow-md border-2 border-white">
                                            ...
                                            <div class="flex-1 min-w-0">
                                                ...
                                                <div class="flex items-center space-x-4 text-sm text-gray-600">
                                                    <span class="inline-flex items-center">
                                                        ...
                                                        Qty: <strong
                                                            class="ml-1 text-gray-900">{{ $item->quantity }}</strong>
                                                    </span>
                                                    <span class="inline-flex items-center">
                                                        <svg class="w-4 h-4 mr-1 text-gray-400" fill="none"
                                                            stroke="currentColor" viewBox="0 0 24 24">
                                                        ...
                                                        Price: <strong
                                                            class="ml-1 text-gray-900">${{ number_format($item->price, 2) }}</strong>
                                                    </span>
                                                </div>
                                            </div>
