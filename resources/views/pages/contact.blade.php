...
@section('title', 'Contact Us - SmartCart')
        ...
        <div class="grid md:grid-cols-2 gap-12 mb-16">
                ...
                <form action="{{ route('contact.submit') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <select id="subject" name="subject" required
                            ...
                            <option value="product" {{ old('subject') == 'product' ? 'selected' : '' }}>Product Question
                            </option>
                            <option value="return" {{ old('subject') == 'return' ? 'selected' : '' }}>Returns & Refunds
                            </option>
                    ...
                    <div class="mb-6">
                        ...
                        <textarea id="message" name="message" rows="5" required
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent @error('message') border-red-500 @enderror">{{ old('message') }}</textarea>
                        @error('message')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
            ...
            <div>
                ...
                <div class="bg-blue-50 border border-blue-200 rounded-lg p-6">
                    ...
                    <a href="{{ route('shipping.policy') }}" class="text-blue-600 hover:text-blue-800 font-medium">
                        Visit Help Center →
                    </a>
                </div>
            </div>
