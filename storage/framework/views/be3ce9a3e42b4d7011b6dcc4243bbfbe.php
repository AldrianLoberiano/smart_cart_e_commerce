...
<body class="bg-gray-100 p-8">
        ...
        <div class="space-y-6">
            ...
            <div class="border-l-4 border-purple-500 pl-4">
                ...
                <div x-data="stockMonitor">
                    ...
                    <p class="text-sm text-gray-600">Products tracked: <span x-text="Object.keys(products).length"></span></p>
                </div>
            </div>
            ...
            <div class="border-l-4 border-red-500 pl-4" x-data="stockMonitor">
                ...
                <div class="space-y-2">
                    ...
                    <div class="p-3 bg-gray-50 rounded" 
                        ...
                        <p class="text-sm">
                            Stock: <span data-stock-display="<?php echo e($product->id); ?>"><?php echo e($product->stock); ?></span>
                            <span class="text-green-600" x-show="products[<?php echo e($product->id); ?>] !== undefined">✓ Tracked</span>
                        </p>
                    </div>
    ...
    <script>
        ...
        function logInfo() {
            ...
            console.log('Window.showNotification:', typeof window.showNotification !== 'undefined' ? 'Loaded' : 'NOT FOUND');
...
<?php /**PATH C:\smart_cart_e_commerce\resources\views/diagnostic.blade.php ENDPATH**/ ?>