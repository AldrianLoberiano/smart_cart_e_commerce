<footer class="bg-gray-900 text-gray-300 mt-16">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm">
                    ...
                    <li><a href="<?php echo e(route('products.index')); ?>" class="hover:text-white transition">Products</a></li>
        ...
        <div class="border-t border-gray-800 mt-8 pt-8 text-sm text-center">
            <p>&copy; <?php echo e(date('Y')); ?> SmartCart. All rights reserved.</p>
        </div>
    </div>
</footer>
<?php /**PATH C:\SmartCart – Modern E-Commerce Web Application\resources\views/layouts/footer.blade.php ENDPATH**/ ?>