...
<div class="card group cursor-pointer transition-transform hover:scale-105">
    ...
    <div class="p-4">
        ...
        <button @click="addItem(<?php echo e($product->id); ?>, 1)" :disabled="isLoading" class="w-full mt-4 btn btn-primary"
...
<?php /**PATH C:\SmartCart – Modern E-Commerce Web Application\resources\views/components/product-card.blade.php ENDPATH**/ ?>