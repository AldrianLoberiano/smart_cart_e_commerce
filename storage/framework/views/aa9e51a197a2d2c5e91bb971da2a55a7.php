...
<?php $__env->startSection('content'); ?>
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="grid md:grid-cols-2 gap-12">
            ...
            <!-- Product Info -->
            <div class="space-y-6" x-data="quantitySelector(1, 1, <?php echo e($product->stock); ?>)">
                <div>
                ...
                <div>
                    <?php if($product->isInStock()): ?>
                        <?php if($product->isLowStock()): ?>
                            <span class="badge badge-warning">Only <?php echo e($product->stock); ?> left in stock</span>
                        <?php else: ?>
                ...
                <div class="space-y-3 pt-4">
                    <button
                        @click="window.dispatchEvent(new CustomEvent('add-to-cart', { detail: { productId: <?php echo e($product->id); ?>, quantity: quantity } }))"
                        :disabled="!<?php echo e($product->isInStock() ? 'true' : 'false'); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\SmartCart – Modern E-Commerce Web Application\smart_cart\resources\views/products/show.blade.php ENDPATH**/ ?>