            ...
            <template x-if="items.length === 0">
                <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-12">
                    <div class="text-center py-12">
                        ...
                        <a href="<?php echo e(route('products.index')); ?>" class="inline-flex items-center px-8 py-4 bg-gradient-to-r from-primary-600 to-primary-700 hover:from-primary-700 hover:to-primary-800 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 transform hover:scale-105">
                    ...
                    <div class="lg:col-span-1">
                        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden sticky top-24">
                            ...
                            <div class="p-6 bg-gray-50 space-y-3">
                                <a href="<?php echo e(route('checkout.index')); ?>" class="block w-full py-4 bg-gradient-to-r from-primary-600 to-primary-700 hover:from-primary-700 hover:to-primary-800 text-white font-bold text-center rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 transform hover:scale-105">
                                ...
                                <a href="<?php echo e(route('products.index')); ?>" class="block w-full py-3 bg-white hover:bg-gray-100 text-gray-700 font-medium text-center rounded-xl border-2 border-gray-200 transition-all duration-200">
                                    <span class="flex items-center justify-center">
                                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
