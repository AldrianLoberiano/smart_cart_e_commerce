    ...
    <div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="hidden md:flex items-center space-x-2 text-sm">
                        <div
                            class="flex items-center space-x-2 px-4 py-2 bg-white rounded-xl shadow-sm border border-gray-200">
            ...
            <?php if(session('error')): ?>
                <div
                    class="bg-gradient-to-r from-red-50 to-rose-50 border-l-4 border-red-500 text-red-900 px-6 py-4 rounded-r-lg mb-8 shadow-sm animate-fade-in-down">
                    <div class="flex items-center">
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-12">
                    <div class="text-center py-12">
                        ...
                        <a href="<?php echo e(route('products.index')); ?>"
                            class="inline-flex items-center px-8 py-4 bg-gradient-to-r from-primary-600 to-primary-700 hover:from-primary-700 hover:to-primary-800 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 transform hover:scale-105">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div class="lg:col-span-2 space-y-4">
                        <template x-for="item in items" :key="item.id">
                            <div
                                class="group bg-white rounded-2xl shadow-lg border border-gray-100 p-6 hover:shadow-xl transition-all duration-300">
                                <div
                                    ...
                                    <div class="relative flex-shrink-0">
                                        <img :src="item.image || 'https://placehold.co/600x400?text=No+Image'"
                                            :alt="item.name"
                                            class="w-32 h-32 object-cover rounded-xl shadow-md group-hover:scale-105 transition-transform duration-300">
                                        <div class="absolute -top-2 -right-2 w-8 h-8 bg-primary-600 text-white rounded-full flex items-center justify-center text-sm font-bold shadow-lg"
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <h3 class="text-xl font-bold text-gray-900 mb-2">
                                            <a :href="`/products/${item.slug}`"
                                                class="hover:text-primary-600 transition-colors" x-text="item.name">
                                            </a>
                                        </h3>
                                        ...
                                        <div class="flex items-center space-x-4">
                                            <div class="flex items-center space-x-3">
                                                ...
                                                <div class="flex items-center bg-gray-100 rounded-xl overflow-hidden">
                                                    ...
                                                    <button
                                                        @click="updateQuantity(`product_${item.id}`, item.quantity + 1)"
                                                        class="px-4 py-2 hover:bg-primary-100 hover:text-primary-700 transition-colors">
                                                        <svg class="w-4 h-4" fill="none" stroke="currentColor"
                                                            viewBox="0 0 24 24">
                                                            <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <!-- Clear Cart -->
                        <div
                            class="flex items-center justify-between p-6 bg-white rounded-2xl shadow-lg border border-gray-100">
                            ...
                            <button
                                @click="if(confirm('Are you sure you want to clear all items from your cart?')) clearCart()"
                        ...
                        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden sticky top-24">
                                    ...
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <div>
                                            ...
                                            <p class="font-semibold text-gray-900"
                                                x-text="itemCount + ' item' + (itemCount > 1 ? 's' : '')"></p>
                                        </div>
                                    </div>
                            ...
                            <div class="p-6 bg-gray-50 space-y-3">
                                <a href="<?php echo e(route('checkout.index')); ?>"
                                    class="block w-full py-4 bg-gradient-to-r from-primary-600 to-primary-700 hover:from-primary-700 hover:to-primary-800 text-white font-bold text-center rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 transform hover:scale-105">
                                ...
                                <a href="<?php echo e(route('products.index')); ?>"
                                    class="block w-full py-3 bg-white hover:bg-gray-100 text-gray-700 font-medium text-center rounded-xl border-2 border-gray-200 transition-all duration-200">
                                    <span class="flex items-center justify-center">
                                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\smart_cart_e_commerce\resources\views/cart/index.blade.php ENDPATH**/ ?>