...
<?php $__env->startSection('title', 'Privacy Policy - SmartCart'); ?>
    ...
    <div class="prose prose-lg max-w-none">
        <section class="mb-8">
            ...
            <p class="text-gray-700 mb-4">
                At SmartCart, we take your privacy seriously. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website and make purchases.
            </p>
        </section>
        ...
        <section class="mb-8">
            ...
            <ul class="list-disc pl-6 text-gray-700 space-y-2">
                <li><strong>Service Providers:</strong> Payment processors, shipping companies, and marketing services</li>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\SmartCart – Modern E-Commerce Web Application\smart_cart\resources\views/pages/privacy-policy.blade.php ENDPATH**/ ?>