...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="flex items-start">
                    ...
                    <label for="terms" class="ml-2 block text-sm text-gray-700">
                        I agree to the
                        <a href="<?php echo e(route('terms.service')); ?>" target="_blank" class="text-primary-600 hover:text-primary-700 font-medium">Terms of Service</a>
                        and
                        <a href="<?php echo e(route('privacy.policy')); ?>" target="_blank" class="text-primary-600 hover:text-primary-700 font-medium">Privacy Policy</a>
                    </label>
                </div>
