...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <option value="general" <?php echo e(old('subject') == 'general' ? 'selected' : ''); ?>>General Inquiry
                            </option>
                            <option value="order" <?php echo e(old('subject') == 'order' ? 'selected' : ''); ?>>Order Status</option>
                            <option value="product" <?php echo e(old('subject') == 'product' ? 'selected' : ''); ?>>Product Question
                            </option>
                            <option value="return" <?php echo e(old('subject') == 'return' ? 'selected' : ''); ?>>Returns & Refunds
                            </option>
                            <option value="technical" <?php echo e(old('subject') == 'technical' ? 'selected' : ''); ?>>Technical
                                Support</option>
            ...
            <div>
                ...
                <div class="bg-blue-50 border border-blue-200 rounded-lg p-6">
                    ...
                    <p class="text-blue-800 mb-4">
                        Check out our help center for instant answers to common questions about orders, shipping, and
                        returns.
                    </p>
        ...
        <div class="bg-gray-50 rounded-lg p-8">
            ...
            <div class="grid md:grid-cols-3 gap-6">
                ...
                <div class="text-center">
                    ...
                    <a href="#" class="text-primary-600 hover:text-primary-800 font-medium text-sm">View
                        Articles</a>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\smart_cart_e_commerce\resources\views/pages/contact.blade.php ENDPATH**/ ?>