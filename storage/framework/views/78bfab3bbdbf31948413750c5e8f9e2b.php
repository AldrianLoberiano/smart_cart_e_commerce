...
<div x-show="isOpen" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0"
    ...
    class="fixed inset-0 bg-black bg-opacity-60 backdrop-blur-sm z-50" style="display: none;">
</div>
...
<div x-show="isOpen" x-transition:enter="transition ease-out duration-300 transform"
    ...
    <div class="flex-1 overflow-y-auto p-6 bg-gray-50">
        ...
        <template x-if="items.length === 0">
            <div class="flex flex-col items-center justify-center h-full text-center py-12">
                ...
                <a href="<?php echo e(route('products.index')); ?>" @click="closeCart"
                    class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-primary-600 to-primary-700 hover:from-primary-700 hover:to-primary-800 text-white font-semibold rounded-xl shadow-lg transition-all duration-200">
        ...
        <template x-if="items.length > 0">
            <div class="space-y-4">
                <template x-for="(item, index) in items" :key="index">
                    <div
                        class="group bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 p-4 border border-gray-100">
                        <div class="flex items-start space-x-4">
                            ...
                            <div class="relative flex-shrink-0">
                                ...
                                <div class="absolute -top-2 -right-2 w-7 h-7 bg-primary-600 text-white rounded-full flex items-center justify-center text-xs font-bold shadow-lg"
    ...
    <div x-show="items.length > 0" class="border-t-2 border-gray-200 bg-white">
        ...
        <div class="p-6 space-y-3">
            ...
            <div
                class="flex items-center justify-between p-4 bg-gradient-to-r from-primary-50 to-primary-100 rounded-xl border-2 border-primary-200">
                <div>
        ...
        <div class="px-6 pb-6 space-y-3">
            ...
            <button @click="closeCart"
                class="block w-full py-3 bg-white hover:bg-gray-50 text-gray-700 font-medium text-center rounded-xl border-2 border-gray-200 transition-all duration-200">
                <span class="flex items-center justify-center">
                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
