                    ...
                    <div class="bg-white rounded-2xl shadow-lg p-6 border border-gray-100 sticky top-4">
                        ...
                        <form method="GET" action="<?php echo e(route('products.index')); ?>" class="space-y-6">
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-2 gap-3">
                                    <input type="number" name="min_price" value="<?php echo e($filters['min_price'] ?? ''); ?>"
                                        placeholder="Min" class="px-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all">
                                    <input type="number" name="max_price" value="<?php echo e($filters['max_price'] ?? ''); ?>"
                                        placeholder="Max" class="px-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all">
                                </div>
                            </div>
                            ...
                            <div class="space-y-3 pt-2">
                                <button type="submit" class="w-full bg-gradient-to-r from-primary-600 to-primary-700 text-white px-6 py-3 rounded-xl font-semibold hover:from-primary-700 hover:to-primary-800 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-105 flex items-center justify-center">
                                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/>
                                    </svg>
                                    Apply Filters
                                </button>
                                <a href="<?php echo e(route('products.index')); ?>" class="block w-full bg-white text-gray-700 px-6 py-3 rounded-xl font-semibold hover:bg-gray-50 transition-all duration-200 border-2 border-gray-300 text-center">
                                    Clear Filters
                                </a>
                            </div>
                        </form>
                        ...
                        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                            <div>
                                <div class="flex items-center mb-2">
                                    <span class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-primary-600 to-primary-700 text-white rounded-xl font-bold text-lg mr-3">
                            ...
                            <div class="w-full md:w-auto">
                                <form method="GET" action="<?php echo e(route('products.index')); ?>" class="flex items-center">
                                    ...
                                    <select name="sort" onchange="this.form.submit()" class="px-4 py-3 pr-10 rounded-xl border border-gray-300 focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all bg-white font-medium">
                                        ...
                                        <option value="name" <?php echo e(($filters['sort'] ?? '') === 'name' ? 'selected' : ''); ?>>Name: A to Z</option>
                                    </select>
                                </form>
                            </div>
                        </div>
...
<?php endif; ?>
                    ...
                    <?php else: ?>
                        <div class="bg-white rounded-2xl shadow-lg p-16 text-center border border-gray-100">
                            ...
                            <a href="<?php echo e(route('products.index')); ?>" class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-primary-600 to-primary-700 text-white rounded-xl font-semibold hover:from-primary-700 hover:to-primary-800 transition-all duration-200 shadow-lg hover:shadow-xl">
                                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
