            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 sticky top-6">
                        <div class="text-center">
                            <div class="inline-block relative mb-4">
                                <div
                                    class="w-32 h-32 bg-gradient-to-br from-primary-500 to-primary-600 rounded-full flex items-center justify-center shadow-xl">
                                    <span
                                        class="text-5xl font-bold text-white"><?php echo e(substr(auth()->user()->name, 0, 1)); ?></span>
                                </div>
                                <div
                                    class="absolute bottom-2 right-2 w-8 h-8 bg-green-400 border-4 border-white rounded-full shadow-lg">
                                </div>
                            </div>
                            <h3 class="text-xl font-bold text-gray-900 mb-1"><?php echo e(auth()->user()->name); ?></h3>
                            <p class="text-sm text-gray-600 mb-4"><?php echo e(auth()->user()->email); ?></p>
                            ...
                            <div class="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-4 border border-blue-100">
                                <div class="flex items-center text-sm text-gray-700">
                                    ...
                                    <div class="text-left">
                                        ...
                                        <p class="font-semibold"><?php echo e(auth()->user()->created_at->format('F d, Y')); ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="lg:col-span-2">
                    <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                        ...
                        <form method="POST" action="<?php echo e(route('account.update')); ?>" class="p-6">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="name" id="name"
                                        ...
                                        class="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <input type="email" name="email" id="email"
                                        ...
                                        class="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 bg-red-50 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <!-- Info Box -->
                                <div
                                    class="bg-gradient-to-r from-blue-50 to-indigo-50 border-l-4 border-blue-500 rounded-r-xl p-4">
                                    <div class="flex items-start">
                                        ...
                                        <div class="text-sm text-blue-900">
                                            ...
                                            <p class="text-blue-800">Changes to your email address may require
                                                verification. You'll receive a confirmation email after updating.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mt-8 flex items-center justify-between pt-6 border-t border-gray-200">
                                ...
                                <button type="submit"
                                    class="inline-flex items-center px-8 py-3 bg-gradient-to-r from-primary-600 to-primary-700 hover:from-primary-700 hover:to-primary-800 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 transform hover:scale-105">
                                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M5 13l4 4L19 7" />
                                    </svg>
                    ...
                    <div class="mt-6 bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <a href="<?php echo e(route('account.password')); ?>"
                                class="flex items-center p-3 bg-gray-50 hover:bg-gray-100 rounded-xl transition-colors group">
                                <div
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\smart_cart_e_commerce\resources\views/account/edit.blade.php ENDPATH**/ ?>