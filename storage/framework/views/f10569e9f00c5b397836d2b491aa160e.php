...
<div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-12">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <!-- Back Button -->
        <div class="mb-8">
            <a href="<?php echo e(route('account.index')); ?>" class="inline-flex items-center text-primary-600 hover:text-primary-700 font-medium transition-colors group">
                    ...
                    <div class="text-center">
                        <div class="inline-block relative mb-4">
                            <div class="w-32 h-32 bg-gradient-to-br from-primary-500 to-primary-600 rounded-full flex items-center justify-center shadow-xl">
                                <span class="text-5xl font-bold text-white"><?php echo e(substr(auth()->user()->name, 0, 1)); ?></span>
                            </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mt-8 flex items-center justify-between pt-6 border-t border-gray-200">
                            <a href="<?php echo e(route('account.index')); ?>" class="inline-flex items-center px-6 py-3 bg-gray-100 hover:bg-gray-200 text-gray-700 font-medium rounded-xl transition-all duration-200">
                ...
                <div class="mt-6 bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <a href="<?php echo e(route('account.password')); ?>" class="flex items-center p-3 bg-gray-50 hover:bg-gray-100 rounded-xl transition-colors group">
                        ...
                        <a href="<?php echo e(route('orders.index')); ?>" class="flex items-center p-3 bg-gray-50 hover:bg-gray-100 rounded-xl transition-colors group">
