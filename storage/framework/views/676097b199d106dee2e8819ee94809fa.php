...
<?php $__env->startSection('title', 'Login - SmartCart'); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <p class="mt-6 text-center text-xs text-gray-500">
            ...
            <a href="<?php echo e(route('terms.service')); ?>" class="text-primary-600 hover:text-primary-700">Terms of Service</a>
            and
            <a href="<?php echo e(route('privacy.policy')); ?>" class="text-primary-600 hover:text-primary-700">Privacy Policy</a>
        </p>
    </div>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\smart_cart_e_commerce\resources\views/auth/login.blade.php ENDPATH**/ ?>