    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
            ...
            <div class="flex items-center space-x-6">
                ...
                <?php if(auth()->guard()->check()): ?>
                    <div x-data="{ open: false }" class="relative">
                        ...
                        <div x-show="open" @click.away="open = false" x-transition
                            ...
                            <a href="<?php echo e(route('account.index')); ?>" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">
                                <div class="flex items-center">
                ...
                <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="text-gray-700 hover:text-primary-600 font-medium transition">
                        Login
                    </a>
                <?php endif; ?>
            </div>
...
<?php /**PATH C:\smart_cart_e_commerce\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>